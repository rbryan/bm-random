...
void
pushParticle (partlist * plist, particle * part)
{
  if (plist->size > 0)
    {
...
particle *
popParticle (partlist * plist, particle * part)
{
  if (plist->size == 1)
    {
      plist->spart = NULL;
...
void
pushPt (pt * point, struct particle *par)
{
